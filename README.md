...
Either, relying on the classpath in the MANIFEST of the `.jar` file (requires exact match of names and versions of all dependencies)
	...
	java -jar calimero-gui-2.6-rc2.jar
...
Or, as example of using the JRE `-classpath`/`-cp` option to qualify all dependencies
	...
	java -cp "calimero-gui-2.6-rc2.jar:calimero-core-2.6-rc2.jar\
	:calimero-tools-2.6-rc2.jar:org.eclipse.swt.gtk.linux.x86_64-3.128.0.jar\
	:slf4j-api-2.0.16.jar:slf4j-simple-2.0.16.jar" tuwien.auto.calimero.gui.Main
